...
function setup(input_source)
    ...
    semi = SemidiscretizationHyperbolic(mesh, equations, initial_condition, solver,
                                        source_terms=input_source)
    semi
end

function solve_problem(semi)
    ###############################################################################
...
function solve_euler(input_source)
    semi = setup(input_source)
    sol = solve_problem(semi)
